  ...
  */
  class Asterisk_AGI
  {
    ...
    */
    ...
    /**
     * Same as above, but in one object :)
     * @var PhpAgi_Request
     */
    var $requestObj;
    ...
    */
    function __construct($config=NULL, $optconfig=array())
    {
      ...
      if(!isset($this->config['phpagi']['error_handler'])) $this->config['phpagi']['error_handler'] = false;
    ...
    */
    ...
    {
        return $this->set_variable("CALLERID(num)", $cid);
    }
