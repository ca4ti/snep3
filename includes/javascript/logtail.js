...
function error(what) {
    ...
    jQuery(dataelem).text("An error occured :-(.\r\n" +
...
jQuery(document).ready(function () {
    ...
    /* Add pause toggle */
    jQuery(pausetoggle).click(function (e) {
        pause = !pause;
        jQuery(pausetoggle).text(pause ? "Unpause" : "Pause");
        show_log();
        e.preventDefault();
    });
