...
class PBX_Khomp_Info {
    ...
    /**
     * hasWorkingBoards - Método que descobre se o sistema tem ou não 
     * placas da khomp instaladas.
     * @return <boolean>
     */
    ...
    /**
     * boardInfo - Retorna informações genéricas sobre uma placa da khomp.
